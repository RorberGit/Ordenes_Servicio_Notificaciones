...
class ProcedenciaDestinoGetAllView(ListAPIView):
    '''
        Vista optimizada de consulta de todos los registros de ProcedenciaDestino
        ...
        try:
            ...
            if not response.data:
                api_response = ApiResponse(
                    success=False,
                    message="No se encontraron procedencias o destinos",
                    data=[],
                    status_code=404
                )
            ...
            api_response = ApiResponse(
                success=True,
                message="Procedencias o Destinos obtenidos exitosamente",
                data=response.data
            )

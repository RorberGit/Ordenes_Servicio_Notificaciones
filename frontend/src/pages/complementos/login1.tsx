  ...
  return (
    <section className='bg-muted h-screen'>
      <div className='flex h-full items-center justify-center'>
        <div className='border-muted flex w-full max-w-sm flex-col items-center gap-y-8 rounded-md border bg-white px-6 py-12 shadow-md'>
          ...
          <div className='flex w-full flex-col gap-8'>
            <div className='flex flex-col gap-4'>
              ...
              <div className='flex flex-col gap-2'>
                <Input type='password' placeholder='Password' required className='bg-white' />
              </div>
              <div className='flex flex-col gap-4'>
